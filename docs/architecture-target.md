...
2. **Migration reliability — completed by Prompt 04 and extended by Prompt 05:** ordered transactional migrations support versions 1–8, reject newer schemas, preserve data, create pre-upgrade backups, validate WAL/integrity behavior, and cover upgrades and interrupted migrations.
