...
2. **Migration reliability — completed by Prompt 04:** ordered transactional migrations support versions 1–7, reject newer schemas, preserve data, create pre-upgrade backups, validate WAL/integrity behavior, and cover upgrades and interrupted migrations.
