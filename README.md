...
See [Development progress](WAID_PROGRESS.md), [architecture overview](docs/architecture.md), [current architecture](docs/architecture-current.md), [target architecture and rules](docs/architecture-target.md), [architecture audit](docs/architecture-audit.md), [dependency injection conventions](docs/dependency-injection.md), [logging and audit operations](docs/logging-and-audit.md), [SQLite persistence and recovery](docs/persistence.md), [configuration and feature flags](docs/configuration.md), [scanner lifecycle and evidence](docs/scanner-framework.md), [development](docs/development.md), and [plugin authoring](docs/plugins.md).
