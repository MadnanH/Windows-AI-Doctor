...
@('NavDashboard','NavDrivers','NavBoot','NavUpdates','NavStorage','NavSecurity','NavNetwork','NavEvidence','NavKnowledge','NavDiagnosis','NavChat','NavHealth','NavPredictive','NavOperations','NavRepairs','NavHistory','NavAudit','NavPlugins')|ForEach-Object{if($main-notmatch$_){throw "Missing automation id $_"}}
