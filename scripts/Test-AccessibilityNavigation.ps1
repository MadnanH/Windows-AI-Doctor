...
@('NavDashboard','NavDrivers','NavBoot','NavUpdates','NavStorage','NavSecurity','NavNetwork','NavEvidence','NavDiagnosis','NavChat','NavHealth','NavOperations','NavRepairs','NavHistory','NavAudit','NavPlugins')|ForEach-Object{if($main-notmatch$_){throw "Missing automation id $_"}}
...
@('DriverHealthPage.xaml','BootHealthPage.xaml','UpdateHealthPage.xaml','StorageCenterPage.xaml','SecurityCenterPage.xaml','NetworkHealthPage.xaml','ChatPage.xaml','EvidenceExplorerPage.xaml')|ForEach-Object{[xml](Get-Content -Raw (Join-Path $root "Views\$_"))|Out-Null}
