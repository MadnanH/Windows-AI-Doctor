...
public sealed partial class MainWindow : Window
{
    ...
    private readonly DashboardViewModel _dashboard; private readonly DiagnosisViewModel _diagnosis; private readonly SettingsViewModel _settings; private readonly HistoryViewModel _history; private readonly OperationsViewModel _operations; private readonly AuditViewModel _audit;
    public MainWindow(DashboardViewModel dashboard,DiagnosisViewModel diagnosis,SettingsViewModel settings,HistoryViewModel history,OperationsViewModel operations,AuditViewModel audit,WAID.Infrastructure.Plugins.PluginCatalog plugins,WAID.Infrastructure.WaidModuleCatalog modules) { InitializeComponent(); _dashboard=dashboard; _diagnosis=diagnosis; _settings=settings; _history=history; _operations=operations;_audit=audit;_plugins=plugins;_modules=modules; Navigation.SelectedItem=Navigation.MenuItems[0]; ShowDashboard(); }
