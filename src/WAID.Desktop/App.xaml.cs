    ...
    public App()
    {
        ...
        try
        {
            ...
            services.AddSingleton<DashboardViewModel>().AddSingleton<DiagnosisViewModel>().AddSingleton<SettingsViewModel>()
                .AddSingleton<HistoryViewModel>().AddSingleton<PredictiveHealthViewModel>().AddSingleton<EvidenceExplorerViewModel>().AddSingleton<KnowledgeViewModel>().AddSingleton<OperationsViewModel>().AddSingleton<AuditViewModel>().AddSingleton<DriverHealthViewModel>().AddSingleton<BootHealthViewModel>().AddSingleton<UpdateHealthViewModel>().AddSingleton<StorageCenterViewModel>().AddSingleton<SecurityCenterViewModel>().AddSingleton<NetworkHealthViewModel>().AddSingleton<ChatViewModel>().AddSingleton<MainWindow>();
