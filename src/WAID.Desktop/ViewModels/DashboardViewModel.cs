...
public sealed class DashboardViewModel : ViewModelBase
{
    ...
    public ObservableCollection<DiagnosticFinding> Findings { get; }=[]; public ObservableCollection<ScannerStatusItem> ScannerPlan { get; }=[]; public ICommand ScanCommand => _scanCommand; public ICommand CancelCommand => _cancelCommand; public ICommand ExportCommand => _exportCommand;
