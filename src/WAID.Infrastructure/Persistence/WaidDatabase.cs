...
,
        ...
        new(24, "Scheduled scan execution history", """
            ...
            """),
        new(25, "Alert delivery and policy state", """
        ...
        new(27, "Versioned repair dry-run metadata", """
            ...
            """),
        new(28, "Validated recovery artifacts and rollback outcomes", """
        ...
        new(29, "Repair safety scoring and policy decisions", """
            ...
            """),
        new(30, "Immutable repair audit chain and bounded outcome aggregates", """
            CREATE TABLE IF NOT EXISTS repair_audit_chain(id TEXT PRIMARY KEY,orchestration_id TEXT NOT NULL,transaction_id TEXT NULL,repair_id TEXT NOT NULL,kind INTEGER NOT NULL,occurred_utc TEXT NOT NULL,outcome INTEGER NOT NULL,entry_json TEXT NOT NULL);
